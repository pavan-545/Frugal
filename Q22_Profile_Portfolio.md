...
- **Resume Download Link (PDF):** `[PUBLIC RESUME LINK TO BE ADDED]`
...
- **Objective:** Build a self-contained local HTML5 Canvas testbed and non-blocking Playwright automation engine to detect pixel-state transitions and execute rapid chained interactions (Hover $\rightarrow$ Drag 15px X $\rightarrow$ Click) under Fibonacci network jitter.
- **Key Technical Contribution:** Engineered a custom browser `requestAnimationFrame` pixel-state detection loop (`getImageData()`) and a 7-stage Circuit-Breaker state machine that detects dynamic coordinate drift ($>5.0\text{ px}$ threshold), invalidates stale coordinates, and recalculates target offsets safely before interaction execution.
...
## 4. Social Engagement Task

Official channels required for candidate engagement:

### Social Media Engagement Checklist & Evidence Placeholders

- [ ] **LinkedIn:** [Frugal Testing LinkedIn Company Page](https://www.linkedin.com/company/frugaltesting/)
  - **Status:** `[SCREENSHOT/EVIDENCE TO BE ADDED]`
  - **Screenshot:** `[INSERT ACTUAL SCREENSHOT]`

- [ ] **Facebook:** [Frugal Testing Facebook Page](https://www.facebook.com/FrugalTest)
  - **Status:** `[SCREENSHOT/EVIDENCE TO BE ADDED]`
  - **Screenshot:** `[INSERT ACTUAL SCREENSHOT]`

- [ ] **Instagram:** [Frugal Testing Instagram Handle](https://instagram.com/frugaltesting)
  - **Status:** `[SCREENSHOT/EVIDENCE TO BE ADDED]`
  - **Screenshot:** `[INSERT ACTUAL SCREENSHOT]`

- [ ] **YouTube:** [Frugal Testing YouTube Channel](https://www.youtube.com/channel/UCjikgYGfeqU4ZPKQNm1V5tg/featured)
  - **Status:** `[SCREENSHOT/EVIDENCE TO BE ADDED]`
  - **Screenshot:** `[INSERT ACTUAL SCREENSHOT]`

- [ ] **Frugal Testing Official Website:** [frugaltesting.com](https://frugaltesting.com/)
  - **Status:** `[SCREENSHOT/EVIDENCE TO BE ADDED]`
  - **Screenshot:** `[INSERT ACTUAL SCREENSHOT]`

- [ ] **BuildNexTech Official Website:** [buildnextech.com](https://buildnextech.com/)
  - **Status:** `[SCREENSHOT/EVIDENCE TO BE ADDED]`
  - **Screenshot:** `[INSERT ACTUAL SCREENSHOT]`
